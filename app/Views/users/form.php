...
<?= csrf_field() ?>
<div class="field"><label for="username">Username</label><input id="username" name="username" required maxlength="50" value="<?= esc(($formInput['username'] ?? '') ?: ($usernameValue ?? ''), 'attr') ?>"></div>
